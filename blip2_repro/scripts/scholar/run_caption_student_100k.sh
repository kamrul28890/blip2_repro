...
CONFIG_PATH="${CONFIG_PATH:-$REPO_ROOT/blip2_repro/configs/caption_student_100k_opt350m.yaml}"
...
VAL_GT="${VAL_GT:-$ANN_ROOT/coco_karpathy_val_student_1k_gt.json}"
RESUME_CKPT="${RESUME_CKPT:-}"

: "${STAGE2_CKPT:?Set STAGE2_CKPT to a stage-2 checkpoint path before running this script.}"

OPTIONS=(
  "model.pretrained=$STAGE2_CKPT"
